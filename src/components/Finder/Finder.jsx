import "./Finder.css";
export function Finder({ setProjectData, setProjectMatch, setProjectAll, input, setInput }) {
  let projectDetails = [
    {
      title: "Login Page",
  ...
  function findProject(input) {
    ...
    projectDetails.map((data) => {
      ...
      let title = data.title.trim().toLowerCase();
